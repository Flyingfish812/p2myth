...
2. 菊花台+喷子波浪
    ...
    要注意的是，使用破坏性波浪的操作是非常有必要的，这不仅使你能够找到正确的反射位置，同时也能及时消灭可能导致伤害溢出的潜在对象。这是因为激光会在消灭敌机后消失，如果大量的激光只用于消灭麻雀，大型的敌机就不会受到足够的伤害，这同样是致命的。
...
3. 大鹏
    ...
    大鹏的起手一定是在底部进行埋炮，这是为了降低大鹏的血量以提供更大的容错空间。通过一个简单的计算就能发现，945血量的大鹏在每秒10伤害的激光反射下，需要95条激光才能完全消灭（激光的持续时间只有1秒）。而一个激光球所能提供的激光数量最多是9，意味着你的护盾必须覆盖尽可能多的激光。事实上，如果场上仅仅有20~30道激光就已经密密麻麻地覆盖住了全屏幕，你的肉眼是无法判断出是否有95道激光的。从这一点上，起手的**埋炮是必需的**。
